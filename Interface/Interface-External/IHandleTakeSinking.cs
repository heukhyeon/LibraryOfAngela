...
namespace LibraryOfAngela.Interface_External
{
    public interface IHandleTakeSinking : ILoABattleEffect
    {
        ...
        /// </summary>
        void OnTakeSinkingReduceStack(BattleUnitBuf_loaSinking buf, ref int value, int originValue);

        /// <summary>
        /// 자신에게 부여된 침잠에 의해 흐트러짐 피해를 받을때 피해량 제어
        /// </summary>
        void BeforeTakeSinkingBreakDamage(BattleUnitBuf_loaSinking buf, ref int dmg, int originDmg);
